package com.cqyw.goheadlines.util;
...
/*
  ...
  */
  ...
  {
    Options localOptions = getBitmapOptions(paramContentResolver, paramUri);
...
*/
  public static Options getBitmapOptions(ContentResolver paramContentResolver, Uri paramUri)
  {
